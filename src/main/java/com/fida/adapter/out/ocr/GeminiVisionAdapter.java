...
public class GeminiVisionAdapter implements OcrPort {
    ...
    private static final String PROMPT =
            "이 이미지는 주식 거래 기록입니다. 아래 JSON 형식으로만 응답하세요 (다른 텍스트 없이 JSON만):\n" +
                    ...
                    "- capital_rows: 오른쪽 상단 자금 표의 라벨/금액 행을 보이는 그대로 모두 기록. 예: [{\"label\":\"시즌1 시작원금\",\"value\":10000.00},{\"label\":\"현사이클 시작\",\"value\":11783.18},{\"label\":\"잔금\",\"value\":8283.77}]. 이미지 맨 위 요약줄의 \"현사이클시작 | N/M\"(분수 형태, 금액 아님) 또는 \"현사이클시작 | 7/10\"(날짜 형태, 금액 아님)은 이 표와 다른 위치의 별개 항목이므로 capital_rows에 절대 포함하지 말 것\n" +
